      ...
      <article className="flex flex-col m-auto desktop:w-[900px] h-[450px] desktop:flex-row desktop:gap-10 desktop:my-20">
        ...
        <section className="flex flex-col m-3">
          <div className="mobile:bg-red z-20 w-72 h-24 rounded-[20px] mt-[-70px] desktop:hidden ml-auto mr-auto">
            ...
            <h4 className="text-m text-light-yellow text-center mt-[-16px] desktop:mb-4">
              {data.location}
            </h4>
          </div>
          ...
          <h4 className="mobile:hidden desktop:flex desktop:text-m desktop:text-red desktop:mt-[-14px] desktop:text-left">
            {data.location}
          </h4>

          <p className="text-s text-blue mobile:mt-4">{data.reason}</p>
        </section>
      </article>
    </>
  );
