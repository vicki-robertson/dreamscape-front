...
return (
    ...
    <div className='flex flex-col md:flex-row lg:w-[733px] h-[509px] rounded-2xl border-4 border-light-yellow sm:p-6'>
    <div class=" items-center w-[300px] lg:basis-1/2 p-4 ">
       ...
       <InputBox size='m' className={'mb-8 content=""'} placeholder="Sube una imagen ..." type="file" id='image' accept="image/*" name="Image" /*value={formData.password} onChange={handleChange}*/ /> 
        <DoubleButton/>
          ...
          <div class="desktop:basis-1/2 items-center w-[300px] mt-20">
